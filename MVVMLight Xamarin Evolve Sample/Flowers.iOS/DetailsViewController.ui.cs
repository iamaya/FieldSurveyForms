...
namespace Flowers
{
    public partial class DetailsViewController : UIViewController
    {
        ...
        private void InitializeComponent()
        {
            ...
            FlowerImage = new UIImageView(new RectangleF(10, 75, 120, 120));
            View.Add(FlowerImage);

            NameText = new UILabel(new RectangleF(140, 75, 170, 30))
            {
            ...
            Scroll = new UIScrollView(new Rectangle(10, 205, 300, 265));
            View.Add(Scroll);

            DescriptionText = new UILabel(new Rectangle(0, 0, 300, 235))
            {
                LineBreakMode = UILineBreakMode.WordWrap,
                Lines = 0,
            };
