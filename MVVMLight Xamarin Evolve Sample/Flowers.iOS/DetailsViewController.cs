            ...
            this.SetBinding(
                ...
                .WhenSourceChanges(
                    () =>
                    {
                        ...
                        NameText.SizeToFit();
                        NameText.Frame = new RectangleF(140, 75, 170, NameText.Bounds.Height);
                    });
            ...
            this.SetBinding(
                ...
                .WhenSourceChanges(
                    () =>
                    {
                        ...
                        DescriptionText.Frame = new RectangleF(0, 0, 300, DescriptionText.Bounds.Height);

                        Scroll.ContentSize = new SizeF(300, DescriptionText.Bounds.Height);
